                  ...
                  children: [
                    ...
                    TextFormField(
                      ...
                      validator: (value) {
                        if (value == null || value.isEmpty)
                          return 'El nombre de la Empresa/Marca es obligatorio';
                        if (value.length < 2 || value.length > 50)
                          return 'El nombre de la Empresa/Marca debe tener entre 2 y 50 caracteres';
                        return null;
                      },
                    ...
                    TextFormField(
                      ...
                      validator: (value) {
                        ...
                        if (value.length < 2 || value.length > 50)
                          return 'El nombre de la Sucursal debe tener entre 2 y 50 caracteres';
                        return null;
                      },
                      style: TextStyle(color: Colors.white),
                      decoration: CustomInputs.loginInputDecoration(
                    ...
                    TextFormField(
                      ...
                      validator: (value) {
                        ...
                        if (!hasUppercase)
                          message += 'Incluir al menos una letra mayúscula.\n';
                        if (!hasLowercase)
                          message += 'Incluir al menos una letra minúscula.\n';
                    ...
                    // Campo de confirmación de contraseña ajustado
                    TextFormField(
                      onChanged: (value) =>
                          registerFormProvider.updateConfirmPassword = value,
                      validator: (value) {
                        // Primero, verifica si el campo está vacío
                        if (value == null || value.isEmpty)
                          return 'La confirmación de la contraseña es obligatoria';

                        // Luego, asegúrate de que la contraseña cumpla con los requisitos mínimos antes de comparar
                        if (registerFormProvider.password.length < 6) {
                          return null; // Evita mostrar "Las contraseñas no coinciden" si la contraseña es corta
                        }

                        // Finalmente, verifica si las contraseñas coinciden
